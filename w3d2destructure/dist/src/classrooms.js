export { collectRoomNumbers, collectRoomsAndCapacities, collectLabeledRoomCaps, findClassroomsWithCapacity, findStudentsOlderThan, averageStudentAge, countStudentsInClassroom, }; //implement these
...
function countStudentsInClassroom(rooms, roomNum) {
